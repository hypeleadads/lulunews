      ...
      try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
          ...
          headers: {
            ...
            'Authorization': 'Bearer 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'
          },
          body: JSON.stringify({
            model: 'gpt-4',
            messages: [
